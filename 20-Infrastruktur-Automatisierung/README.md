...
![AWS_Konto](/20-Infrastruktur-Automatisierung/Screenshots/Screenshot1.png)
...
![AWS_Konto](/20-Infrastruktur-Automatisierung/Screenshots/Screenshot2.png)
...
![AWS_Konto](/20-Infrastruktur-Automatisierung/Screenshots/Screenshot3.png)

4. Klicken Sie auf "Benutzer" und erstellen Sie einen neuen Benutzer mit dem Namen "vagrant".
   
![AWS_Konto](/20-Infrastruktur-Automatisierung/Screenshots/Screenshot4.png)

5. Weisen Sie diesem Benutzer die "Berechtigungsrichtlinie" "AmazonEC2FullAccess" zu.
   
![AWS_Konto](/20-Infrastruktur-Automatisierung/Screenshots/Screenshot5.png)

6. Überprüfen Sie erneut, ob "Frankfurt" als Rechenzentrum ausgewählt ist.
   
![AWS_Konto](/20-Infrastruktur-Automatisierung/Screenshots/Screenshot6.png)
    
7. Erstellen Sie eine Sicherheitsgruppe, die Datenverkehr über Port 22 und Port 80 an die VM zulässt.
   
![AWS_Konto](/20-Infrastruktur-Automatisierung/Screenshots/Screenshot7.png)
        
8. Erstellen Sie ein Schlüsselpaar und speichern Sie die .pem-Datei im Hauptverzeichnis des Vagrant-Projekts.
...
![AWS_Konto](/20-Infrastruktur-Automatisierung/Screenshots/Screenshot8.png)
